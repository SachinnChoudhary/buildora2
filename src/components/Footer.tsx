    ...
    <footer className="border-t border-white/10 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 pt-16 pb-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-12 mb-16">
          ...
          {/* Platform */}
          <div>
            <h3 className="text-white font-semibold mb-4 tracking-wide uppercase text-xs">Platform</h3>
            <ul className="space-y-2.5">
              <li><Link href="/projects" className="text-gray-400 hover:text-brand-purple transition-colors text-sm">Explore Projects</Link></li>
              <li><Link href="/custom-requests" className="text-gray-400 hover:text-brand-purple transition-colors text-sm">Custom Engineering</Link></li>
              <li><Link href="/pricing" className="text-gray-400 hover:text-brand-purple transition-colors text-sm">Pricing</Link></li>
              <li><Link href="/dashboard" className="text-gray-400 hover:text-brand-purple transition-colors text-sm">Dashboard</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-sm">Careers</a></li>
            </ul>
          </div>

          {/* Legal */}
          <div>
            <h3 className="text-white font-semibold mb-4 tracking-wide uppercase text-xs">Legal</h3>
            <ul className="space-y-2.5">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-xs">
            &copy; {new Date().getFullYear()} Buildora Inc. All rights reserved. Built with ❤️ for engineers.
          </p>
